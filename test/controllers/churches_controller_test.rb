...
class ChurchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create church" do
    assert_difference('Church.count') do
      post churches_url, params: { church: { address: @church.address, city: @church.city, cnpj: @church.cnpj, name: @church.name, state: @church.state } }
    end
  ...
  test "should update church" do
    patch church_url(@church), params: { church: { address: @church.address, city: @church.city, cnpj: @church.cnpj, name: @church.name, state: @church.state } }
